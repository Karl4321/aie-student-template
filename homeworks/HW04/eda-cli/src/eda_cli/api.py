...
@app.post("/quality-flags-from-csv", response_model=FlagResponse, tags=["quality"], summary = "Возвращает полный набор флагов качества")
async def quality_flags_from_csv(file: UploadFile = File(...)) -> FlagResponse:
    ...
    return FlagResponse(flags=flags_all)
