...
def report(
    ...
    title: str = typer.Option("Какой-то интересный отчётик про EDA CSV файла, приятного",help="Заголовок отчёта"),
    top_k_categories: int = typer.Option(2, help="top k категорий для вывода")
) -> None:
    """
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Все уникальные значения колонки user_id: **{quality_flags['has_suspicious_id_duplicates']}**\n")
